 ...
 * - Se non iscritto, inserisce nella tabella Partecipare.
 *
 * @param {*} nome
 * @param {*} cognome
 * @param {*} ranking
  ...
  try {
    ...
    await connection.execute(
      "INSERT INTO atleta (CodiceFIS, Nome, Cognome, Ranking) " +
        ...
        "Nome = VALUES(Nome), Cognome = VALUES(Cognome), Ranking = VALUES(Ranking)",
    ...
    // 4. Inserisco iscrizione
    await connection.execute(
      "INSERT INTO partecipare (CodiceFIS, IdTorneo) VALUES (?, ?)",
      [codiceFIS, idTorneo]
    );
